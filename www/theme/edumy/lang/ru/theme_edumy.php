...
$string['config_visibility'] = 'Видимость';
...
$string['config_ccn_carousel_autoplay'] = 'Автовоспроизведение';
$string['config_ccn_carousel_autoplay_timeout'] = 'Автовоспроизведение: Длительность';
$string['config_ccn_carousel_speed'] = 'Автовоспроизведение: Скорость';
$string['config_ccn_carousel_autoplay_pause'] = 'Автовоспроизведение: Пауза при наведении';
$string['config_ccn_carousel_loop'] = 'Циклично';
$string['config_ccn_carousel_lazyload'] = 'Ленивая загрузка изображений';
$string['config_ccn_carousel_animateout'] = 'Animate out';
$string['config_ccn_carousel_animatein'] = 'Animate in';
$string['config_ccn_margin_top'] = 'Внешний отступ (margin) сверху';
$string['config_ccn_margin_bottom'] = 'Внешний отступ (margin) снизу';
$string['config_ccn_padding_top'] = 'Внутренний отступ (padding) сверху';
$string['config_ccn_padding_bottom'] = 'Внутренний отступ (padding) снизу';
$string['config_ccn_css_class'] = 'Кастомный CSS класс';
$string['config_updated'] = 'Обновлен';
$string['config_rating'] = 'Рейтинг';
$string['config_description'] = 'Описание';
...
$string['config_prev'] = 'Предыдущее';
$string['config_next'] = 'Далее';
$string['config_arrow_style'] = 'Arrow style';
$string['config_hover_text'] = 'Текст при наведении';
...
$string['config_color_bg'] = 'Фон';
$string['config_color_title'] = 'Заголовок';
$string['config_color_subtitle'] = 'Подзаголовок';
...
$string['config_video'] = 'Видео';
$string['config_countdown_date'] = 'Дата отсчета';
$string['config_button'] = 'Кнопка';
...
$string['rated_by'] = '{$a} оценок студентов';
$string['rate_course'] = 'Submit rating';
$string['number_of_courses'] = 'Больше {$a} курсов';
$string['number_of_subcategories'] = 'Больше {$a} категорий';
$string['categories'] = 'Категории';
$string['hidden'] = 'Скрыт';
$string['back_to_course'] = 'Вернуться к курсу';
$string['back_to_site'] = 'Вернуться на сайт';
$string['course_navigation'] = 'Навигация по курсу';
$string['rating_success'] = 'Rating complete!';
// CCN Dashboard Constants
$string['messages_desc'] = 'Общение';
$string['messages_title'] = 'Сообщения';
$string['profile_desc'] = 'Ваш профиль';
$string['profile_title'] = 'Профиль';
$string['preferences_desc'] = 'Персональные настройки';
$string['preferences_title'] = 'Настройки';
$string['grades_desc'] = 'Успеваемость';
$string['grades_title'] = 'Оценки';
// CCN Regions
...
$string['region-navbar'] = 'Панель навигации';
// CCN Theme Settings
$string['headerlogo1'] = 'Header logo (Light)';
$string['headerlogo1_desc'] = 'Светлый вариант логотипа вашего сайта.';
$string['headerlogo2'] = 'Header logo (Dark)';
$string['headerlogo2_desc'] = 'Темный вариант логотипа вашего сайта.';
$string['headerlogo3'] = 'Header logo (Large)';
$string['headerlogo3_desc'] = 'Увеличенный вариант логотипа вашего сайта.';
$string['headerlogo4'] = 'Header logo (Login page)';
$string['headerlogo4_desc'] = '(Необязательно) Загрузите логотип для страницы входа (логина). Если пусто, будет использоваться логотип по умолчанию (Header Logo Light).';
$string['headerlogo_mobile'] = 'Header logo (Mobile)';
$string['headerlogo_mobile_desc'] = 'Мобильный вариант логотипа вашего веб-сайта (необязательно).';
...
$string['cocoon_copyright_desc'] = 'Уведомление об авторских правах для вашего веб-сайта.';
$string['social_settings'] = 'Социальные сети';
$string['cocoon_facebook_url'] = 'Facebook URL';
$string['cocoon_facebook_url_desc'] = 'Ссылка на профиль вашей компании в Facebook.';
$string['cocoon_twitter_url'] = 'Twitter URL';
$string['cocoon_twitter_url_desc'] = 'Ссылка на профиль вашей компании в Twitter.';
$string['cocoon_instagram_url'] = 'Instagram URL';
$string['cocoon_instagram_url_desc'] = 'Ссылка на профиль вашей компании в Instagram.';
$string['cocoon_dribbble_url'] = 'Dribbble URL';
$string['cocoon_dribbble_url_desc'] = 'Ссылка на профиль вашей компании в Dribbble.';
$string['cocoon_pinterest_url'] = 'Pinterest URL';
$string['cocoon_pinterest_url_desc'] = 'Ссылка на профиль вашей компании в Pinterest.';
$string['cocoon_google_url'] = 'Google URL';
$string['cocoon_google_url_desc'] = 'Ссылка на профиль вашей компании в Google.';
$string['cocoon_youtube_url'] = 'YouTube URL';
$string['cocoon_youtube_url_desc'] = 'Ссылка на профиль вашей компании на YouTube.';
$string['cocoon_vk_url'] = 'VK URL';
$string['cocoon_vk_url_desc'] = 'Ссылка на профиль вашей компании Вконтакте.';
...
$string['cocoon_whatsapp_url_desc'] = 'Ссылка на профиль вашей компании в WhatsApp.';
$string['cocoon_wordpress_url'] = 'WordPress URL';
$string['cocoon_wordpress_url_desc'] = 'Ссылка на профиль вашей компании на WordPress.';
...
$string['cocoon_telegram_url_desc'] = 'Ссылка на профиль вашей компании в Telegram.';
$string['cocoon_moodle_url'] = 'Moodle URL';
$string['cocoon_moodle_url_desc'] = 'Ссылка на профиль вашей компании Moodle.';
...
$string['headertype_desc'] = 'Выберите стиль шапки (header) для веб-сайта. Обратите внимание, что некоторые поля ниже применимы только к определенным стилям header-ов.';
$string['email_address'] = 'Email адрес';
$string['email_address_desc'] = 'Адрес электронной почты вашей компании.';
$string['phone'] = 'Номер телефона';
$string['phone_desc'] = 'Номер телефона вашей компании.';
...
$string['footertype_desc'] = 'Выберите стиль подвала (footer) для веб-сайта. Обратите внимание, что некоторые поля ниже применимы только к определенным стилям footer-ов.';
$string['footer_col_1'] = 'Footer столбец 1';
$string['footer_col_2'] = 'Footer столбец 2';
$string['footer_col_3'] = 'Footer столбец 3';
$string['footer_col_4'] = 'Footer столбец 4';
$string['footer_col_5'] = 'Footer столбец 5';
$string['footer_col_title'] = 'Заголовок столбца';
$string['footer_col_title_desc'] = 'Заголовок для столбца footer-a.';
$string['footer_col_body'] = 'Тело (body) столбца';
$string['footer_col_body_desc'] = 'Внутреннее содержание столбца footer-a. Можно использовать HTML.';
$string['footer_menu'] = 'Footer меню';
$string['footer_menu_desc'] = 'The content for the footer menu. HTML is allowed.';
$string['general_settings'] = 'Основные';
$string['blogstyle'] = 'Стиль блога';
$string['blogstyle_desc'] = 'Стиль для блога на сайте.';
$string['courseliststyle'] = 'Стиль списка курсов';
$string['courseliststyle_desc'] = 'Стиль для отображения категорий курсов.';
$string['optimization_settings'] = 'Оптимизация';
$string['lazy_loading'] = 'Ленивая подгрузка изображений';
$string['lazy_loading_desc'] = 'Ленивая подзагрузка ускоряет работу вашего веб-сайта, загружая изображения только после их появления в поле зрения пользователя. Edumy версии 2.5 и выше вводит экспериментальную отложенную загрузку в некоторых разделах вашего веб-сайта Moodle.';
$string['advanced_settings'] = 'Продвинутые настройки';
...
$string['user_settings'] = 'Пользователи';
...
$string['color_settings'] = 'Цвета';
$string['color_settings_gradient'] = 'Градиент';
...
$string['color_settings_main'] = 'Общие цвета';
...
$string['favicon_desc'] = 'Favicon сайта. Рекомендованный размер 16 x 16px.';
...
$string['language_menu'] = 'Выбор языка';
$string['language_menu_desc'] = 'Настройки языкового меню.';
$string['blog_post_author'] = 'Автор записи в блоге';
$string['blog_post_author_desc'] = 'Показывать или скрывать имя автора в записях блога. Этот параметр управляет страницей со списком блогов, отдельными записями в блоге и всеми блоками [Cocoon].';
$string['blog_post_date'] = 'Дата публикации поста в блоге';
$string['blog_post_date_desc'] = 'Показывать или скрывать дату в записях блога. Этот параметр управляет страницей со списком блогов, отдельными записями в блоге и всеми блоками [Cocoon].';
...
$string['logo_image_width'] = 'Ширина изображения логотипа';
$string['logo_image_width_desc'] = 'Ширина логотипа в пикселях для header-a. Введите только числовое значение и не указывайте "px".';
$string['logo_image_height'] = 'Высота изображения логотипа';
$string['logo_image_height_desc'] = 'Высота логотипа в пикселях для header-a. Введите только числовое значение и не указывайте "px".';
...
$string['dashboard_settings'] = 'Панель инструментов';
$string['dashboard_settings_long'] = 'Настройки панели инструментов';
$string['dashboard_icons'] = 'Dashboard icons';
$string['dashboard_icons_visibility'] = 'Видимость иконок на панели навигации';
$string['dashboard_icons_visibility_desc'] = 'Показывать или скрывать иконки на панели управления пользователя.';
...
$string['breadcrumb_settings'] = 'Навигационная цепочка';
...
$string['preloader_settings'] = 'Загрузка страницы';
$string['preloader_duration'] = 'Preloader duration';
$string['preloader_duration_desc'] = 'Время, в течение которого будет отображаться анимация загрузки страницы. Настоятельно рекомендуется оставить это значение по умолчанию. Чтобы ускорить время загрузки, мы рекомендуем сжимать изображения перед загрузкой на сайт.';
...
$string['coursecat_modified'] = 'Последнее обновление';
$string['coursecat_modified_desc'] = 'Show the date that the course/category was last updated.';
$string['coursecat_enrolments'] = 'Зачисления на курс';
$string['coursecat_enrolments_desc'] = 'Показывать количество студентов, зачисленных на курс.';
...
$string['coursecat_prices'] = 'Цена курса';
$string['coursecat_prices_desc'] = 'Показывать цены на курсы в списках категорий и блоках.';
$string['coursecat_settings'] = 'Course category settings';
$string['single_course_settings'] = 'Single course settings';
$string['course_single_style'] = 'Стиль страницы с подробной информацией о курсе';
$string['course_single_style_desc'] = 'Select the style to use on single courses.';
$string['course_start_date'] = 'Дата начала курса';
$string['course_start_date_desc'] = 'Отображать дату начала на подробной странице курса, над содержанием курса.';
$string['course_category'] = 'Категория курса';
$string['course_category_desc'] = 'Отображать категорию на подробной странице курса, над содержанием курса.';
$string['seo'] = 'SEO';
...
$string['edumy_focus_sidebar'] = 'Отображать боковую панель навигации?';
...
$string['logo_url'] = 'Лого URL';
$string['logo_url_desc'] = 'Override the logo URL in all Edumy headers and footers.';

// CCN Fixes
$string['allexcepthidden'] = 'Все (кроме скрытых)';

// Theme Edumy
$string['studentsiamteaching'] = 'Студенты, которых я обучаю';
$string['coursesiamteaching'] = 'Кусры, на которых я преподаю';
$string['coursesiamtaking'] = 'Курсы, в которых я принимаю участие';
$string['profileviews'] = 'My profile views';
$string['socialmedia'] = 'Social media';
$string['accessed'] = 'Accessed';
$string['last_accessed'] = 'последний доступ';
$string['last_accessed_courses'] = 'Последние посещенные курсы';
$string['select_no_cat'] = 'Please select number of categories.';
$string['navigation'] = 'Navigation';
$string['start'] = 'Start';
$string['login_welcome'] = 'Войти в аккаунт';
$string['login'] = 'Login';
$string['login_no_account'] = 'Don\'t have an account?';
$string['signup'] = 'Sign up!';
$string['search_courses'] = 'Поиск курсов...';
$string['forgot_password'] = 'Забыли пароль?';
$string['or'] = 'Или';
$string['login_register'] = 'Войти';
$string['your_name'] = 'Your name';
$string['your_name_requirements'] = 'Minimum 3 letters/spaces.';
$string['email_address'] = 'Электронная почта';
$string['email_address_requirements'] = 'Валидная электронная почта.';
$string['subject'] = 'Subject';
$string['subject_requirements'] = 'Минимум 5 символов.';
$string['message'] = 'Message';
$string['message_requirements'] = 'Минимум 5 символов.';
$string['send'] = 'Send';
$string['lectures'] = 'Лекции';
...
$string['course_free_to_join'] = 'присоединиться';
...
$string['item'] = 'Item';
$string['your_order'] = 'Спасибо за заказ.';
$string['payment_method'] = 'Метод оплаты:';
$string['receipt'] = 'Чек';
$string['date'] = 'Статус зачисления';
$string['status'] = 'Статус';
$string['total'] = 'Общее количество:';
$string['total_courses'] = 'Курсы';
$string['price'] = 'Цена';
...
$string['instructors'] = 'Учителя';
$string['last_online'] = 'Был(а) в сети в';
$string['comments'] = 'комментарии';
$string['reviews'] = 'Отзывы';
$string['preview_course'] = 'Предпросмотр курса';
$string['library'] = 'Каталог';
$string['have_an_account'] = 'Есть аккаунт?';
$string['course_content'] = 'Контент курса';
$string['end_date'] = 'Дата окончания';
$string['view'] = 'Посмотреть';
$string['published'] = 'Опубликован';
...
$string['ccn_cf_free'] = 'Бесплатно';
$string['ccn_cf_paid'] = 'С оплатой';
$string['ccn_cf_5_stars'] = '5 звезд и выше';
$string['ccn_cf_4_stars'] = '4 звезды и выше';
$string['ccn_cf_3_stars'] = '3 звезды и выше';
$string['ccn_cf_2_stars'] = '2 звезды и выше';
$string['ccn_cf_1_stars'] = '1 звезда и выше';
$string['ccn_cf_show_all'] = 'Посмотреть все';
$string['ccn_cf_all_matching'] = 'Все совпадающие';
$string['no_students_yet'] = 'Пока что студентов нет.';
$string['no_courses_yet'] = 'Пока что курсов нет.';
