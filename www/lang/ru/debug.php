...
$string['reactive_instances'] = 'Реактивные экземпляры:';
$string['reactive_noinstances'] = 'На этой странице нет реактивных экземпляров.';
...
$string['reactive_saveingwarning'] = 'Предупреждение: редактирование состояния может привести к неожиданным результатам.';
