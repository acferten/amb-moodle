...
/**
 * Strings for component 'theme_adaptable', language 'ru', version '4.1'.
 *
...
$string['activatetemplateoverride'] = 'Активировать переопределение шаблона для «{$a}»';
$string['activatetemplateoverridedesc'] = 'При установленном флажке значение в параметре «{$a->setting}», содержащее текст, будет использоваться в качестве шаблона «{$a->template}».';
...
$string['analyticsprofilefield'] = 'Имя поля пользовательского профиля=значение (необязательно)';
...
$string['blockiconsheadersizedesc'] = 'Установите размер значка шрифта, используемого в заголовке блоков moodle. Выберите значение из списка.';
$string['blocklayoutbuilder'] = 'Регионы блоков главной страницы';
$string['blocklayoutbuilderdesc'] = 'Ниже вы можете создать свой собственный макет для областей блоков на главной странице.<br/>Чтобы добавить содержимое в эти области, вам нужно <strong> включить редактирование на главной странице Moodle</strong>.<br/> Затем вы можете начать перетаскивать блоки в созданные области!';
...
$string['blockmaintopradius'] = 'Верхний радиус основного блока';
$string['blockmaintopradiusdesc'] = 'Установите верхний радиус области основного блока для достижения эффекта изогнутости / закругления';
$string['blockregionbackground'] = 'Цвет фона области блока';
$string['blockregionbackgrounddesc'] = 'Цвет фона контейнера, содержащего пользовательские макеты блоков на главной странице.';
$string['blocksettings'] = 'Настройки блока';
$string['blockside'] = 'Расположение блоков';
$string['blocksidedesc'] = 'Управляйте отображением блоков слева или справа на странице';
$string['breadcrumb'] = 'Цвет фона верхнего меню навигации';
$string['breadcrumbbackgroundcolor'] = 'Цвет фона строки навигации';
$string['breadcrumbbackgroundcolordesc'] = 'Задайте цвет фона строки навигации.';
$string['breadcrumbdisplay'] = 'Отображение строки навигации';
$string['breadcrumbdisplaydesc'] = 'Установите, что должно отображаться в области строки навигации курса';
$string['breadcrumbhomedesc'] = 'Отображать элементы строки навигации в виде значка или текста.';
...
$string['tabbedlayouttablabeldashboard'] = 'Содержимое Личного кабинета';
