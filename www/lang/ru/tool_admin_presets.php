...
/**
 * Strings for component 'tool_admin_presets', language 'ru', version '4.1'.
 *
...
$string['applypresetdescription'] = 'Если вы передумаете после применения этой предустановки, вы можете отменить изменения настроек через «Показать историю версий» в меню действий предустановки.';
$string['author'] = 'Автор';
...
$string['includesensiblesettings_help'] = 'Настройки с паролями содержат конфиденциальную информацию, относящуюся к вашему сайту. Включайте эти настройки только в том случае, если вы создаете предустановку для повторного использования на своем сайте. Список настроек с паролями вы можете найти в предустановленных настройках администратора сайта в Управлении сайтом.';
