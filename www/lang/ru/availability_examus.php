...
/**
 * Strings for component 'availability_examus', language 'ru', version '4.1'.
 *
...
$string['examus:proctor_auth'] = 'Авторизоваться в Экзамус, как синхронный проктор';
$string['examus:reviewer_auth'] = 'Авторизоваться в Экзамус, как асинхронный проктор';
$string['fader_awaiting_proctoring'] = 'Ожидание прокторинга';
$string['fader_instructions'] = '<p>Используйте Экзамус для прохождения тестирования</p>';
$string['fromdate'] = 'С:';
...
$string['select_groups'] = 'Использовать Экзамус только для выбраных групп';
...
$string['todate'] = 'По:';
$string['use_examus'] = 'Используйте «Экзамус», чтобы получить доступ к тестированию';
$string['user_agreement_url'] = 'Ссылка на правила экзамена';
