...
/**
 * Strings for component 'qtype_multichoiceset', language 'ru', version '4.1'.
 *
...
$string['showstandardinstruction'] = 'Показывать стандартные инструкции';
$string['showstandardinstruction_help'] = 'Нужно ли показывать инструкцию «Выберите один или несколько ответов:» перед  ответами в вопросе «Всё или ничего».';
