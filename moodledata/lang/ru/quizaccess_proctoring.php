...
/**
 * Strings for component 'quizaccess_proctoring', language 'ru', version '4.1'.
 *
...
$string['eprotroringreports'] = 'Отчет о проверке личности:';
...
$string['notpermissionreport'] = 'Отчеты о проверке личности для вас отключены.';
$string['notrequired'] = 'не обязательный';
$string['openwebcam'] = 'Разрешить веб-камере продолжить работу';
...
$string['proctoringstatement'] = 'Этот экзамен требует использования веб-камеры. Вы должны разрешить использование веб-камеры и она будет делать случайные снимки во время тестирования. <br />(Разрешите браузеру доступ к камере).';
