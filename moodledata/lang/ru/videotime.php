...
/**
 * Strings for component 'videotime', language 'ru', version '4.1'.
 *
 * @package     videotime
 * @category    string
...
$string['viewpercentgrade_help'] = 'Создать элемент оценки для этого видео. Студент получит оценку, равную проценту просмотра видео.';
