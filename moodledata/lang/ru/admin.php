...
$string['configsupportpage'] = 'Ссылка на эту страницу будет представлена пользователям для обращения в службу поддержки сайта. При пустом поле будет представлена ссылка на форму поддержки.';
