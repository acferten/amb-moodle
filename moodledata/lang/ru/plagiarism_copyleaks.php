...
/**
 * Strings for component 'plagiarism_copyleaks', language 'ru', version '4.1'.
 *
...
$string['cldefaultrepositoriespagetitle'] = 'Настройки хранилищ Copyleaks по умолчанию';
$string['cldefaultsettings'] = 'Настройки плагина плагиата Copyleaks по умолчанию';
...
$string['cleditrepositories'] = 'Изменить настройки хранилищ';
$string['clenable'] = 'Включить Copyleaks';
$string['clenablecheatdetection'] = 'Включить обнаружение читерства';
$string['clenablemodulefor'] = 'Включить Copyleaks для {$a}';
$string['clenablesafesearch'] = 'Включить безопасный поиск';
$string['clfailtoloaddata'] = 'Не удалось загрузить данные Copyleaks';
...
$string['clignorequotes'] = 'Игнорировать кавычки';
$string['clignorereferences'] = 'Игнорировать ссылки';
$string['clignoreresourcecodecomments'] = 'Игнорировать комментарии к исходному коду';
$string['clignoreretableofcontents'] = 'Игнорировать оглавление';
$string['clignoretitles'] = 'Игнорировать заголовки';
...
$string['clrepositoriespagetitle'] = 'Настройки хранилищ Copyleaks';
$string['clscaninternaldatabase'] = 'Сканировать внутреннюю базу данных';
$string['clscaninternet'] = 'Сканировать интернет';
